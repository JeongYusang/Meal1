...
function result(){
	...
	<div class='board-wrap'>
		...
		<form name="frmArticle" method="post" action="${contextPath}/board1/board1insert.do"
			...
			<div class='table-wrap'>
				<table>
					...
					<tr>
						...
						<input class="B_Uid" type=text value="${ memberInfo.u_id}"
							name="_u_id"  disabled/>
							<input type="hidden" value="${memberInfo.u_id }" name="u_id">
							<input type="hidden" value="user" name="reg_id">
							<div class="secret-wrap"><input class="B_Uid1" type="checkbox" value= "Y" name="secret">비밀글입니다.</input>
							</div></td>
					</tr>
					</c:when>
					...
					<tr>
						...
						<input class="B_Uid" type=text value="${sellerInfo.s_id }"
							name="_s_id"  disabled/>
					...
					<tr>
						<th class="td1">제목</th>
						<td class="td2">
						<input type=text value="타이틀필드" name="title" id="i_title" /></td>
							<input type="hidden" value="${board1VO.b_1_id }" name="parentNo">
					</tr>
					<tr>
						<th class="td1">내용</th>
						<td class="td2">
						<textarea rows="20" cols="70" name="content" id="i_content" > ${article.content } </textarea></td>
					</tr>
				<tr  height="200px" >
