...
<script>
   ...
   function fnc_BLsearch(){
	   ...
	   var data = {
			    "b_no": [BL_NUM] // 사업자번호 "xxxxxxx" 로 조회 시,
			   }; 
			   
			$.ajax({
			  url: "https://api.odcloud.kr/api/nts-businessman/v1/status?serviceKey=OwmWknQevMBVAwqqWjdxNQpqRTK3x6NXQzUhrIxWBaKXZuALFrwd9V8%2FJ%2BLY7RXkrQVkTPi2O3Ub7DhTa45BZQ%3D%3D",  // serviceKey 값을 xxxxxx에 입력
			  type: "POST",
            ...
            <table class="any">
               ...
               <tr class="box">
                  ...
                  <td id="BLNum"><input type="text" id="s_BL_Num"
                     name="s_BL_Num" placeholder="사업자등록번호">
                    </td>
                    <td> <input type="button" id ="BL_BTN" name="BL_BTN" value="확인하기" onclick="fnc_BLsearch()">
                     </td>
               </tr>
               <tr class="box">
