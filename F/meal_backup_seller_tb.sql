...
--
-- Table structure for table `backup_seller_tb`
--

DROP TABLE IF EXISTS `backup_seller_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `backup_seller_tb` (
...
--
-- Dumping data for table `backup_seller_tb`
--

LOCK TABLES `backup_seller_tb` WRITE;
/*!40000 ALTER TABLE `backup_seller_tb` DISABLE KEYS */;
/*!40000 ALTER TABLE `backup_seller_tb` ENABLE KEYS */;
UNLOCK TABLES;
