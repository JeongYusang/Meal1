...
CREATE TABLE `cart_tb` (
  ...
  KEY `u_id` (`u_id`),
  KEY `g_id` (`g_id`),
  CONSTRAINT `cart_tb_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `user_tb` (`u_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cart_tb_ibfk_2` FOREIGN KEY (`g_id`) REFERENCES `goods_tb` (`g_id`) ON DELETE CASCADE ON UPDATE CASCADE
